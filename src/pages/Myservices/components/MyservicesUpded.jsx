...
const MyservicesUpded = (props) => {
    const { category, price, serviceArea, serviceImage, serviceName, textarea, _id } = props.singleItemData;
    ...
    const handelSubmit = (e) => {
        ...
        axiosData.post(`/updedservice/${_id}`, data)
            .then(res => {
                console.log(res.data)
                swal("Good job!", "You services upded sucessfully!", "success");
                        ...
                        <div className="p-4 pt-0 sm:pt-0 sm:p-7">
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className='flex w-full' ><img className='h-[150px] w-[400px] object-cover bg-center border' src={imgUplode} alt='Change image' /> <img className='h-[150px] w-1/2 object-cover bg-center border' src={serviceImage} alt={serviceName} /></div>
                                    <label className="block p-4 text-center border-2 border-gray-200 border-dashed rounded-lg cursor-pointer group sm:p-7 focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2 dark:border-gray-700">
                                        <input onChange={uploadImageToImgBB} id="fileInput" name="image" type="file" className="sr-only" />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select defaultValue={category} name='category' id="af-submit-app-category" className="block w-full px-3 py-2 text-sm border-gray-200 rounded-lg shadow-sm pr-9 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                                        ...
                                        <option value='Home with outdoor space'>Home with outdoor space</option>
                                        <option value='Remote friendly homes'>Remote friendly homes</option>
                                        <option value='kid friendly homes'>kid friendly homes</option>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input defaultValue={price} name='price' id="af-submit-app-project-name" type="number" className="block w-full px-3 py-2 text-sm border-gray-200 rounded-lg shadow-sm pr-11 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Enter Service Price" />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea defaultValue={textarea} name='textarea' id="af-submit-app-description" className="block w-full px-3 py-2 text-sm border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" rows="6" placeholder="A detailed summary will better explain your products to the audiences. Our users will see this in your dedicated product page."></textarea>
                                </div>
                            </div>
                        ...
                        <div className="p-4 overflow-y-auto sm:p-7">
                            ...
                            <div className="grid grid-cols-2 gap-5 mt-5 sm:mt-10 sm:grid-cols-3">
                                <div>
                                    ...
                                    <span className="block text-sm font-medium text-gray-800 dark:text-gray-200">{user?.emailVerified ? "Valid" : "Invalid"}</span>
                                </div>
                                <div>
...
export default MyservicesUpded;